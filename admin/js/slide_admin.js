...
jQuery( document ).ready(
	function ($) {
		...
		$( 'body' ).on(
			'click',
			'.rt-image-uploader .rt-button-delete',
			function ( e ) {
				e.preventDefault();
		...
		$( document ).on(
			'click',
			'.repeater .repeater-footer .add-row-end',
			function ( e ) {
				e.preventDefault();
				var $this = $( this );
		...
		$( document ).on(
			'click',
			'.repeater td.remove .add-row-before',
			function ( e ) {
				e.preventDefault();
		...
		$( document ).on(
			'click',
			'.repeater td.remove .rt-button-remove',
			function ( e ) {
				e.preventDefault();
		...
		var sortElements = {
			...
			render: function () {
				...
				this.$el.find( '> table > tbody > tr.row' ).each(
					function (i) {
